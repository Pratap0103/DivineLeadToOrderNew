...
function CallTracker() {
  ...
  const pendingHeaders = [
    "Actions", "Timestamp", "Lead No.", "Enquiry Type", "Lead Receiver Name", "Lead Source",
    "Person Name", "Phone No.", "Company Name", "Current Stage", "Calling Date"
  ];
  ...
  const renderPendingRow = (tracker, index) => (
    <tr key={tracker.id || index} className="hover:bg-slate-50">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{tracker.assignedTo}</td>
      ...
      {isAdmin() && <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{tracker.salespersonName}</td>}
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
